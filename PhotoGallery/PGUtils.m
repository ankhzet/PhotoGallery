...
{
    NSError *error = nil;
    NSManagedObjectContext *managedObjectContext = [[self getInstance] managedObjectContext];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[PGUtils applicationDocumentsDirectory] URLByAppendingPathComponent:@"PhotoGallery.sqlite"];
